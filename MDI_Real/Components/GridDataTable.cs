...
namespace SmartZuSoft.SmartTester.Components {
	/// <summary>
...
//		private System.Windows.Forms.MenuItem m_MenuDelete;
		...
		private SourceGrid2.VisualModels.Common rowHeader;
		private SourceGrid2.VisualModels.Common columnHeader;
		private SourceGrid2.VisualModels.Common header;
		private bool _isFlatColumnHeader = false;
		private bool _isFlatRowHeader    = false;

		protected bool IsFlatColumnHeader {
			get {return _isFlatColumnHeader;}
			set {_isFlatColumnHeader = value;}
		}

		protected bool IsFlatRowHeader {
			get {return _isFlatRowHeader;}
			set {_isFlatRowHeader = value;}
		}
...
//				m_MenuDelete.Enabled = false;
		...
		public System.Data.DataRow FocusDataRow {
			get {
				if (Selection.FocusPosition.IsEmpty() || Selection.FocusPosition.Row < FixedRows || (Selection.FocusPosition.Row-1) >= m_DataSelection.Count)
					return null;
				else {
					return (System.Data.DataRow)m_DataSelection[Selection.FocusPosition.Row-1];
				}
			}
		}
		public System.Data.DataColumn FocusDataColumn {
			get {
				if (Selection.FocusPosition.IsEmpty() || Selection.FocusPosition.Column < FixedColumns || (Selection.FocusPosition.Column-1) >= m_DataCell.Length)
					return null;
				else {
		...
		public class CellColumnTemplate : SourceGrid2.Cells.Virtual.CellVirtual {
			...
			public CellColumnTemplate(System.Data.DataColumn p_DataColumn, string p_ColumnCaption) {
				...
				DataModel.EnableEdit = !m_DataColumn.ReadOnly;
			}
